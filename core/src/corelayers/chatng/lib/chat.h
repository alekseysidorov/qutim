...
class QUICKCHAT_EXPORT Chat : public qutim_sdk_0_3::ChatLayer
{
    Q_OBJECT
	...
	Q_PROPERTY(QDeclarativeListProperty<ChatChannel> channels READ channels NOTIFY channelsChanged)
public:
    explicit Chat();
	virtual ~Chat();
